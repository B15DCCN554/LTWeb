		...
		<div class="navbar-end">
			...
			<div class="navbar-item">
				<div class="field is-grouped">
					<p class="control">
						<a target="_self" style="color: #ee4d2d !important;" class="button"
							data-social-network="Twitter" data-social-action="Facebook"
							data-social-target="" target="_blank"
							href="<%=client != null ? request.getContextPath() + "/Trangchu/Payment" : String.format(Constants.FACEBOOK_LINK_GET_CODE, Constants.FACEBOOK_APP_ID, Constants.FACEBOOK_REDIRECT_URL)%>">
							<span class="icon"> <%
 if (client != null)
 	out.print("<i class=\"fa fa-money\" aria-hidden=\"true\"></i>");
 else
 	out.print("<i class=\"fa fa-facebook\"></i>");
 %>
						</span> <span> <%
 if (client != null)
