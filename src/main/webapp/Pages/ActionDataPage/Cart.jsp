...
<body>
	...
	<footer id="site-footer">
		<div class="container clearfix">
			<div class="left">
				<h3 class="subtotal">
					<b>Subtotal:</b> <span><%=Product.formMoney(Long.toString(subtotal))%></span> VNĐ
				</h3>
				<h3 class="tax">
					<b>Taxes (2%):</b> <span> <%
 ...
 %>
			...
			<div class="right">
				<h1 class="total">
					<b style="color: red;">Total: <span><%=subtotal != 0 ? Product.formMoney(Long.toString(tax + subtotal + 20000)) : 0%></span> VNĐ
				</b> </h1>
				<%
				if (subtotal != 0) {
